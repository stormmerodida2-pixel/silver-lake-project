...
// to fix, not repeat.
const trustPoints = [
  { text: 'Local expertise, rooted in Kisumu', icon: 'pin' },
  { text: 'National reach, across Kenya', icon: 'route' },
  { text: 'A personal touch, every trip', icon: 'heart' },
]
</script>
