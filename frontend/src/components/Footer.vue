      ...
      <div class="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-3">
        <div>
          ...
          <div class="mt-3 flex flex-col gap-2 text-sm">
            <a href="tel:+254710315345" class="flex items-center gap-2 text-foreground hover:text-accent">
            ...
            <a
              href="https://wa.me/254798184193?text=Hello%20SilverLake%20Car%20Rentals%2C%20I%27d%20like%20to%20book%20a%20car."
              target="_blank"
