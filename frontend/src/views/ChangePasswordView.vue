...
<template>
  <div class="bg-page">
    <div class="mx-auto max-w-md px-4 py-16 sm:px-6">
      ...
      <h1 class="mt-4 text-center font-[Georgia] text-3xl font-bold text-foreground">Change Password</h1>

      <form class="mt-8 space-y-4 rounded-xl border border-border-subtle bg-surface p-6" @submit.prevent="submit">
        <div>
          <label class="mb-1 block text-sm text-foreground-muted">Current password</label>
          <PasswordInput
        ...
        <p v-if="success" class="text-sm text-success">Password changed successfully.</p>
        <button
          type="submit"
          :disabled="submitting"
