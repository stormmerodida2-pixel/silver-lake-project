  ...
  <div class="bg-white">
    ...
    <section class="bg-navy-950 py-20">
      <div class="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <p class="mt-5 text-slate-300">
          Rooted in Kisumu. Driven across Kenya. We're here whenever you need us.
        </p>
      </div>
    </section>
    ...
    <section class="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      <div class="grid gap-6 sm:grid-cols-3">
        ...
        >
          <div class="flex h-14 w-14 items-center justify-center rounded-full bg-gold-500/10 text-gold-600 transition group-hover:bg-gold-500 group-hover:text-navy-950">
            <svg class="h-7 w-7" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 0 1 2-2h3.28a1 1 0 0 1 .948.684l1.498 4.493a1 1 0 0 1-.502 1.21l-2.257 1.13a11.042 11.042 0 0 0 5.516 5.516l1.13-2.257a1 1 0 0 1 1.21-.502l4.493 1.498A1 1 0 0 1 21 16.72V19a2 2 0 0 1-2 2h-1C9.716 21 3 14.284 3 6V5Z" />
            </svg>
          </div>
        ...
        >
          <div class="flex h-14 w-14 items-center justify-center rounded-full bg-green-500/10 text-green-600 transition group-hover:bg-green-500 group-hover:text-white">
        ...
        >
          <div class="flex h-14 w-14 items-center justify-center rounded-full bg-brand-blue-500/10 text-brand-blue-600 transition group-hover:bg-brand-blue-600 group-hover:text-white">
            <svg class="h-7 w-7" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
        ...
        <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p class="mt-5 leading-relaxed text-slate-600">
              SilverLake Car Rentals was founded with a simple vision: to offer Kenyans and visitors alike
              a premium, reliable, and human-centred car rental experience. We started in Kisumu —
              the heart of the Lake Victoria region — and have grown to serve clients across the entire country.
            </p>
            <p class="mt-4 leading-relaxed text-slate-600">
              Whether you're heading to a corporate meeting in Nairobi, a safari in the Mara,
              or a family trip along the coast, we match you with the right vehicle and the right driver,
              every time.
            </p>
          </div>
    ...
    <section class="mx-auto max-w-5xl px-4 py-16 sm:px-6 text-center">
      ...
      <div class="mt-6 overflow-hidden rounded-2xl border border-slate-200 shadow-lg">
        <iframe
          ...
          title="SilverLake Car Rentals location — Kisumu, Kenya"
        ></iframe>
      </div>
    </section>
  </div>
