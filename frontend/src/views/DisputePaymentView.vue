    ...
    <div class="mx-auto max-w-lg px-4 py-16 sm:px-6">
      ...
      <template v-else-if="payment">
        ...
        <div
          ...
          class="mt-6 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-6 text-center"
        >
          <div
        ...
        <div v-else class="mt-6 space-y-4 rounded-2xl border border-border-subtle bg-surface p-6">
          ...
          <div>
            <label class="mb-1 block text-sm text-foreground-muted">What happened? (optional)</label>
            <textarea
              v-model="note"
              rows="3"
