      ...
      >
        ...
        <div v-if="heroVehicle" v-reveal class="relative mx-auto w-full max-w-xs sm:max-w-sm lg:max-w-lg">
          <div class="relative">
            ...
            <!-- Fleet photography is studio-shot on a white background - kept as a clean, clearly
                 defined card rather than trying to blend it into the page. Several blending
                 attempts (a plain transparency fade, a color wash matched to the page background,
                 and a much-larger-scale version of that wash) each read as an odd or distracting
                 effect rather than a natural blend, so this goes back to a simple, honest
                 presentation instead. -->
            <div class="relative overflow-hidden rounded-2xl bg-white shadow-xl shadow-black/30">
