...
<template>
  <div>
    ...
    <div v-if="!loading" class="mt-6 space-y-3">
        ...
        <div class="flex items-start justify-between gap-3">
          <div>
            <div class="flex items-center gap-2">
              ...
              <span v-if="!announcement.is_active" class="rounded-full bg-navy-800 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-slate-500">
                Inactive
              </span>
            </div>
      ...
      <p v-if="!announcements.length" class="p-6 text-center text-slate-400">No announcements yet.</p>
    </div>
        ...
        >
          <div class="w-full max-w-lg rounded-2xl border border-navy-700 bg-navy-900 p-8 shadow-2xl">
            <div class="mb-6 flex items-center justify-between">
              <h2 class="font-[Georgia] text-xl font-bold text-white">New Announcement</h2>
