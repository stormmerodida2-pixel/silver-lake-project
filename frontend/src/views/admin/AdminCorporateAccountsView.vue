...
<template>
  <div>
    <div class="flex items-center justify-between">
      <div>
        <h1 class="font-[Georgia] text-2xl font-bold text-white">Corporate Accounts</h1>
    ...
    <div v-if="!loading" class="mt-6 space-y-3">
      <div v-for="account in accounts" :key="account.id" class="rounded-xl border border-navy-800 bg-navy-900 p-4">
      ...
      <p v-if="!accounts.length" class="p-6 text-center text-slate-400">No corporate accounts yet.</p>
    </div>
