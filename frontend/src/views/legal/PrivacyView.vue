  ...
  <div class="bg-white">
    <section class="bg-navy-950 py-16">
      <div class="mx-auto max-w-3xl px-4 text-center sm:px-6">
        ...
        <h1 class="mt-3 font-[Georgia] text-4xl font-bold text-white">Privacy Policy</h1>
    ...
    <section class="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <div class="space-y-10 text-slate-700">
        ...
        <div>
          <h2 class="font-[Georgia] text-xl font-bold text-navy-900">1. Information We Collect</h2>
        ...
        <div>
          <h2 class="font-[Georgia] text-xl font-bold text-navy-900">2. How We Use Your Information</h2>
        ...
        <div>
          <h2 class="font-[Georgia] text-xl font-bold text-navy-900">7. Children's Privacy</h2>
          <p class="mt-3 leading-relaxed">
