    ...
    <section class="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <div class="space-y-10 text-foreground-muted">
        <p class="leading-relaxed">
          This policy explains how deposits, cancellations, and refunds work for SilverLake Car Rentals bookings. It
          applies alongside our
          <RouterLink to="/terms" class="font-semibold text-accent hover:text-accent-strong"
        ...
        <div>
          ...
          <div class="mt-4 overflow-x-auto rounded-xl border border-border-subtle">
            <table class="w-full text-left text-sm">
              <thead class="bg-surface text-foreground">
                <tr>
              ...
              <tbody class="divide-y divide-border-subtle">
                <tr>
                  ...
                  <td class="px-4 py-3 font-semibold text-accent">100%</td>
                  <td class="px-4 py-3 text-foreground-subtle">Not refunded</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="px-4 py-3 font-semibold text-accent">50%</td>
                  <td class="px-4 py-3 text-foreground-subtle">Not refunded</td>
                </tr>
                <tr>
                  <td class="px-4 py-3">Client cancels before driver accepts (optional)</td>
                  <td class="px-4 py-3 font-semibold text-accent">100%</td>
                  <td class="px-4 py-3 text-foreground-subtle">Refunded or retained (SilverLake's choice)</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p class="mt-3 leading-relaxed text-sm text-foreground-subtle">
        ...
        <div>
          ...
          <ul class="mt-3 list-disc space-y-2 pl-5 leading-relaxed">
            ...
            <li>
              <strong>24-48 hours before pickup:</strong> 50% of the deposit is refunded; the remainder covers
              vehicle-holding costs.
            </li>
            <li><strong>Less than 24 hours before pickup, or a no-show:</strong> the deposit is non-refundable.</li>
          </ul>
          <p class="mt-3 leading-relaxed text-sm text-foreground-subtle">
            These windows are measured from your scheduled pickup date/time to the moment you cancel.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            option to rebook a comparable vehicle at no extra cost.
          </p>
        </div>
