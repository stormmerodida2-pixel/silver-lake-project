    ...
    <section class="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <div class="space-y-10 text-slate-700">
        <p class="leading-relaxed">
          These Terms of Service ("Terms") govern your use of SilverLake Car Rentals' website and booking services (the
          "Service"). By creating an account, making a booking, or applying as a driver-partner, you agree to these
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            pickup. We may refuse a self-drive booking if these documents are missing, expired, or appear fraudulent.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            Co-operative Bank of Kenya, Paybill 400200, Account: 01101465587001 - payable via M-Pesa or directly from
            your own bank; a driver may also accept cash or a card payment in person for an assigned trip. Self-serve
            online card payments will be enabled in future. Prices are quoted in Kenyan Shillings (KES) and may change
            without notice for future bookings, but not for a booking you have already confirmed with a deposit.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            <RouterLink to="/refund-policy" class="font-semibold text-brand-blue-600 hover:text-brand-blue-500">
              Refund &amp; Cancellation Policy </RouterLink
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            booking unless agreed with us in advance. Off-road use, racing, or use outside Kenya without our written
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            driver, vehicle, or other road users at risk may be declined.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            not cover damage arising from reckless, unlicensed, or unauthorised use. To the fullest extent permitted by
            law, SilverLake Car Rentals is not liable for indirect or consequential losses arising from your use of the
            Service.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-3 leading-relaxed">
            ...
            insurance requirements. We may suspend a driver-partner's account, with reason communicated to them, if
