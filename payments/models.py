...
class PaymentMethod(models.TextChoices):
    ...
    # A government-contract or corporate-account invoice settling, weeks or months after the
    # trip - staff-recorded once it actually clears (see
    # core.views.AdminBookingViewSet.record_invoice_payment), never created automatically the
    # way an M-Pesa/card payment is.
